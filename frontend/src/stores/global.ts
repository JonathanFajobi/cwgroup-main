    ...
    actions: {
        async saveUser() {
            ...
            if (this.user.id == null || this.user.id == undefined) {
                ...
                const id = parseInt(fetchFromCookie("user_data"));
            ...
            const response = await getCurrentUserInfo({ id: String(id) }) as User;
            console.log("Response from getCurrentUserInfo:", response);
        }
    }
})